    ...
    <ul class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
      ...
      >
        <div class="flex items-center mb-4">
          <img :src="crypto.image" :alt="crypto.name" class="w-12 h-12 mr-4" />
          <div>
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p
              :class="{
                'text-green-600': crypto.price_change_percentage_24h > 0,
                'text-red-600': crypto.price_change_percentage_24h < 0,
              }"
            >
              {{ crypto.price_change_percentage_24h.toFixed(2) }}%
              <span v-if="crypto.price_change_percentage_24h > 0">↑</span>
              <span v-else>↓</span>
            </p>
          </div>
          <div>
